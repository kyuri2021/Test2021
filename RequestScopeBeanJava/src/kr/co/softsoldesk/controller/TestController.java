...
public class TestController {
	...
	//RootAppContext.java 에서 정의한 DataBean1의 주입(type방법)
	//@RequestScope에 의해 정의되어 있으므로 새로운 요청이 발생했을때 객체가 생성됨
	@Autowired
	DataBean1 requestBean1;
	//--------------------------------------
	
	//이름을 통한 주입이므로 @Resource사용
